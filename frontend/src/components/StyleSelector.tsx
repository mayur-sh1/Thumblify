...
import { ImageIcon, PenToolIcon, SquareIcon, SparkleIcon, CpuIcon, ChevronDownIcon } from "lucide-react";
...
const StyleSelector = ({value,onChange,isOpen,setIsOpen}:{value:ThumbnailStyle;onChange:(style:ThumbnailStyle)=>void;isOpen:boolean,setIsOpen:(open:boolean)=>void}) => {
    ...
    const styleDesciptions:Record<ThumbnailStyle,string>={
        "Bold & Graphic":"Highy contrast, bol typography, and striking visuals.",
